...
parser.add_argument('--attack-type', default=None, type=str, choices=[None, 'fgsm', 'pgd'])
parser.add_argument('--adv-eps', default=1., type=float)
parser.add_argument('--adv-steps', default=5, type=int)
parser.add_argument('--adv-step-size', default=.5, type=float)
